...
public class LandUseMixOMS {
  ...
  public void landUseMixMeasure() {
    ...
    try {
      ...
      SimpleFeatureCollection lumRegions = LandUseMix.summarise(landUse, regions, categories, classificationAttribute);
  ...
  public void validateOutputs() throws IOException {
    ...
    if (resultsSource.getCount(new Query()) == 0) {
      throw new IllegalArgumentException(
          "Cannot continue tool execution; no results were produced");
    }
  }
}